...
dfsum2 = All %>% filter(str_detect(chem,"Ca|Turbiditet|SPM|SiO2|TOC|TOTN|TOTP|As|Pb|Cd|Cu|Zn|Cr|PO4"))
```
...
ggsave(filename = "TOTP22_Facet.png",
       plot = plot20,
       width = 11, height = 8.5, units = "in")
...
ggsave(filename = "PO422_Facet.png",
       plot = PO422,
       width = 11, height = 8.5, units = "in")
...
Dxa2022y$TPP = Dxa2022y$TOTP - Dxa2022y$PO4.P
